...
function confirmGotoShowtime() {
  Swal.fire({
    title: 'Thông tin',
    icon: 'info',
    html: '<p>Hiện tại chức năng xem lịch chiếu trực tiếp vẫn đang được hoàn thiện.</p><p>Bạn có muốn chuyển hướng đến trang <b>Mua vé</b> để xem lịch chiếu đầy đủ không?',
