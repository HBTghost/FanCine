...
// ===== HTML elements =====
var ticketRowElements = document.querySelectorAll('#mnticket-table tbody tr');
var tableRowElements = document.querySelectorAll('#mnticket-table tr');
var tableBodyElement = document.querySelector('#mnticket-table tbody');
var displayCheckboxElements = document.querySelectorAll('#mnticket-display .mmnticket-display-item input'); // Global variables
...
function handleEvents() {
  eventDisplayCheckboxes(); // eventRowTickets();
} // ===== Main =====
